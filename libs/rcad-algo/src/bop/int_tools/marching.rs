...
/// Numeric IntSS uses the same order of magnitude as **`refine_tol`** when refining grid seeds ([`crate::bop::int_tools::intss::intersect_surfaces_with_density_tol`] pathway).
