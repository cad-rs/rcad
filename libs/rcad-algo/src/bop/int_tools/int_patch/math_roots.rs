...
//   math_BracketedRoot, math_BrentMinimum.
//
...
/// OCCT math_BrentMinimum (math_BrentMinimum.cxx / .hxx / .lxx) — Brent's
/// method to find the minimum of a function of a single variable.
...
impl BrentMinimum {
    ...
    pub fn perform(&mut self, f: &mut dyn FunctionValue, ax: f64, bx: f64, cx: f64) {
