...
use rcad_brep::tools::{ShapeType, get_shape_type};
...
///
/// ```ignore
/// use rcad_algorithms::crate::bop::brep_algo_api::argument_analyzer::ArgumentAnalyzer;
...
impl ArgumentAnalyzer {
    ...
    fn check_single_self_interference(&self, shape: &BRep, is_shape1: bool) -> Option<CheckResult> {
        ...
        for interf in interferences.iter().take(20) {
            ...
            if is_shape1 {
                match interf {
                    crate::bop::ds::Interference::VertexVertex { v1, .. } => {
                        result.add_faulty1(*v1);
                    }
                    crate::bop::ds::Interference::EdgeEdge { e1, .. } => {
                        result.add_faulty1(*e1);
                    }
                    crate::bop::ds::Interference::FaceFace { f1, .. } => {
                        result.add_faulty1(*f1);
                    }
                    crate::bop::ds::Interference::VertexEdge { vertex, .. } => {
                        result.add_faulty1(*vertex);
                    }
                    crate::bop::ds::Interference::EdgeFace { edge, .. } => {
                        result.add_faulty1(*edge);
                    }
                    crate::bop::ds::Interference::VertexFace { vertex, .. } => {
                        result.add_faulty1(*vertex);
                    }
                }
            } else {
                match interf {
                    crate::bop::ds::Interference::VertexVertex { v2, .. } => {
                        result.add_faulty2(*v2);
                    }
                    crate::bop::ds::Interference::EdgeEdge { e2, .. } => {
                        result.add_faulty2(*e2);
                    }
                    crate::bop::ds::Interference::FaceFace { f2, .. } => {
    ...
    ///   BSpline knot multiplicity not tracked 鈥?needed for C0 detection.
