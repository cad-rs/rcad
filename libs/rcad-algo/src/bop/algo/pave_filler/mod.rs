// OCCT BOPAlgo_PaveFiller 閳?intersection computation.
//
...
use crate::bop::ds::DS;
/// BOPAlgo_PaveFiller 閳?intersection engine.
...
impl<'a> PaveFiller<'a> {
    ...
    // ==================================================================
    // Perform 閳?main entry point (BOPAlgo_PaveFiller::Perform)
    // ==================================================================
    pub fn perform(&mut self) {
        // 1. Prepare 閳?build pcurves and initialize DS
        self.prepare();
