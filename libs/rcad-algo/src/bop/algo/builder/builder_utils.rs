use crate::bop::algo::builder::SourceSide;
use crate::bop::algo::builder::types::{BooleanOpType, WireEdgeSource, WireOrientation, WireSegment};
use crate::bop::ds::*;
...
use crate::bop::algo::builder::angle_2d::angle_2d;
use crate::bop::algo::builder::edge_builders::is_split_to_reverse;
use crate::bop::algo::builder::wire_splitter::{
...
///  PointInFace  妞??= ?FaceSampleData =UV domain  = ?
...
///  IsInternalFace  妞??(BOPTools_AlgoTools.cxx L791-872)
///
///  妞?
