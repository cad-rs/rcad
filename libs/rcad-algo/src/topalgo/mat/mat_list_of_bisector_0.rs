...
use super::mat_tlist_node_of_list_of_bisector_0::{
    HandleMatTListNodeOfListOfBisector, MatTListNodeOfListOfBisector,
};

/// OCCT `occ::handle<MAT_ListOfBisector>`
pub type HandleMatListOfBisector = Arc<RwLock<MatListOfBisector>>;

/// OCCT MAT_ListOfBisector.hxx L28-94 (MAT_TList for Item = MAT_Bisector)
pub struct MatListOfBisector {
    thefirstnode: Option<HandleMatTListNodeOfListOfBisector>,
    thelastnode: Option<HandleMatTListNodeOfListOfBisector>,
    thecurrentnode: Option<HandleMatTListNodeOfListOfBisector>,
    thecurrentindex: i32,
...
impl MatListOfBisector {
    ...
    pub fn init(&mut self, anitem: &HandleMatBisector) {
        self.first();
        while self.more() {
    ...
    pub fn current(&self) -> Option<HandleMatBisector> {
        self.thecurrentnode
            .as_ref()
    ...
    pub fn set_current(&self, anitem: &HandleMatBisector) {
        self.thecurrentnode
            .as_ref()
            .expect("MAT_TList::Current")
            .write()
    ...
    pub fn first_item(&self) -> Option<HandleMatBisector> {
        self.thefirstnode
            .as_ref()
    ...
    pub fn last_item(&self) -> Option<HandleMatBisector> {
        self.thelastnode
            .as_ref()
    ...
    pub fn previous_item(&self) -> Option<HandleMatBisector> {
        let prev = self
            .thecurrentnode
            .as_ref()
    ...
    pub fn next_item(&self) -> Option<HandleMatBisector> {
        let next = self
            .thecurrentnode
            .as_ref()
    ...
    pub fn brackets(&mut self, anindex: i32) -> Option<HandleMatBisector> {
    ...
    pub fn link_before(&mut self, anitem: &HandleMatBisector) {
        self.thenumberofitems += 1;
        if self.thecurrentindex != 0 {
            self.thecurrentindex += 1;
        }

        let mut previous: Option<HandleMatTListNodeOfListOfBisector> = None;

        let node = Arc::new(RwLock::new(MatTListNodeOfListOfBisector::new_item(anitem)));
    ...
    pub fn link_after(&mut self, anitem: &HandleMatBisector) {
        self.thenumberofitems += 1;
        let mut next: Option<HandleMatTListNodeOfListOfBisector> = None;
    ...
    pub fn front_add(&mut self, anitem: &HandleMatBisector) {
        self.thenumberofitems += 1;
        if self.thecurrentindex != 0 {
            self.thecurrentindex += 1;
        }
    ...
    pub fn back_add(&mut self, anitem: &HandleMatBisector) {
        self.thenumberofitems += 1;
        let node = Arc::new(RwLock::new(MatTListNodeOfListOfBisector::new_item(anitem)));
    ...
    pub fn permute(&mut self) {
        ...
        let null: Option<HandleMatTListNodeOfListOfBisector> = None;
...
impl Drop for MatListOfBisector {
    fn drop(&mut self) {
