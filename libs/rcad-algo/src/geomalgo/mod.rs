...
pub mod geom_surface_iso; // Geom_RectangularTrimmedSurface construction (TKG3d/Geom) — the Geom_Surface::UIso/VIso dispatch lives in brep_fill::brep_fill_sweep
