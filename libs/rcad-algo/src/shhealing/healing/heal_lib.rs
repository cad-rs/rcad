...
pub fn fix_solid(brep: &rcad_kernel::BRep, _tolerance: f64) -> (rcad_kernel::BRep, SolidFixReport) {
 use crate::algo_ext::brep_repair::{fix_face_orientation, recompute_face_normals};
...
pub fn fix_wire(brep: &rcad_kernel::BRep, tolerance: f64) -> (rcad_kernel::BRep, WireFixReport) {
 use crate::algo_ext::brep_repair::fix_wire_orientation;
...
pub struct WireIssueLocation {
 ...
 pub face: usize,
 pub wire_idx: usize,
 pub issues: crate::algo_ext::brep_check::WireIssueReport,
}
...
pub fn analyze_wire_issues(brep: &rcad_kernel::BRep, wire: &rcad_kernel::topology::Wire, tolerance: f64) -> crate::algo_ext::brep_check::WireIssueReport {
 use rcad_kernel::topods::TShape;
 ...
 *vertex_count.entry(ev).or_insert(0) += 1;
 ...
 crate::algo_ext::brep_check::WireIssueReport {
 solid: 0,
 shell: 0,
 face: 0,
 wire_idx: 0,
...
pub fn heal_comprehensive(brep: &rcad_kernel::BRep, options: &HealingOptions) -> (rcad_kernel::BRep, ComprehensiveHealingReport) {
 ...
 &current,
 options.tolerance,
 crate::algo_ext::brep_repair::ToleranceFlowDirection::BottomUp,
 );
 let tol_report = crate::algo_ext::brep_repair::analyze_tolerances(&current, options.tolerance);
...
pub struct ComprehensiveHealingReport {
 ...
 pub repair_report: Option<crate::algo_ext::brep_repair::RepairReport>,
 /// Solid-level fix report.
 pub solid_report: Option<SolidFixReport>,
 /// Tolerance propagation report.
 pub tolerance_report: Option<crate::algo_ext::brep_repair::ToleranceStats>,
