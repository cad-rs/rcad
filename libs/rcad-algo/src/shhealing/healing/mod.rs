...
pub struct ComprehensiveDiagnosis {
    ...
    pub surface_uv: crate::algo_ext::brep_check::SurfaceAnalysisReport,
    /// Wire quality analysis.
    pub wire_quality: crate::algo_ext::brep_check::WireQualityReport,
    /// SameParameter diagnosis.
    pub same_parameter: crate::algo_ext::brep_check::SameParameterDiagnosis,
    /// SameRange diagnosis.
    pub same_range: crate::algo_ext::brep_check::SameRangeDiagnosis,
}
