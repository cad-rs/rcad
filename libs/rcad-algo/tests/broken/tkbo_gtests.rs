...
use rcad_algo::bop::algo::builder::BooleanOpType;
use rcad_algo::bop::algo::pave_filler::PaveFiller;
use rcad_algo::bop::ds::DS;
use rcad_algo::bop::tools::bvh::Bvh;
use rcad_algo::bool_ops_ext::make_face_half_space;
use rcad_algo::tolerance::TOLERANCE_ABS;
...
mod bop_algo_direct_tests {
    ...
    fn perform_bop(
        ...
        rcad_algo::bop::brep_algo_api::fuse(rcad_algo::bop::brep_algo_api::fuse(op, a, b).expect("BOP operation failed")a, rcad_algo::bop::brep_algo_api::fuse(op, a, b).expect("BOP operation failed")b).expect("fuse failed")
    }
    ...
    fn direct_common_overlapping_boxes() {
        ...
        let result = rcad_algo::bop::brep_algo_api::fuse(BooleanOpType::Intersection, &b1, &b2)
...
mod bop_algo_two_step_tests {
    ...
    fn perform_two_step_bop(
        ...
        let mut builder = rcad_algo::bop::algo::builder::BooleanBuilder::with_brep(
            &ds,
            op,
            brep,
            Vec::new(),
...
mod bop_algo_complex_tests {
    ...
    fn perform_direct_bop(
        ...
        rcad_algo::bop::brep_algo_api::fuse(op, a, b).expect("Direct BOP failed")
    }
    ...
    fn direct_vs_two_step_equivalent() {
        ...
        let two_step =
            rcad_algo::bop::brep_algo_api::fuse(BooleanOpType::Union, &sphere, &box_)
...
mod int_tools_face_face_tests {
    use super::*;
    use rcad_algo::bop::int_tools::face_face::intersect_faces;
    use rcad_algo::bop::int_tools::int_ana_quad_quad_geo::QuadQuadGeo;
    use rcad_algo::bop::int_tools::int_surf_quadric::Quadric;
...
mod quad_quad_geo_tests {
    use super::*;
    use rcad_algo::bop::int_tools::int_ana_quad_quad_geo::*;
    use rcad_algo::bop::int_tools::int_surf_quadric::Quadric;
    use rcad_kernel::geom::*;
...
mod edge_edge_tools_tests {
    ...
    fn curve_type_to_integer_all_types() {
        use rcad_algo::bop::int_tools::edge_edge::curve_type_to_integer;
        assert_eq!(
    ...
    fn point_box_distance_inside() {
        use rcad_algo::bop::int_tools::edge_edge::point_box_distance;
    ...
    fn split_range_on_segments_basic() {
        use rcad_algo::bop::int_tools::edge_edge::split_range_on_segments;
    ...
    fn intersect_line_line_3d_coincident_overlap() {
        use rcad_algo::bop::int_tools::edge_edge::intersect_line_line_3d;
...
mod ds_interf_tests {
    ...
    fn allocate_pave_block_returns_increasing_indices() {
        let mut ds = crate::bop::ds::DS::new_empty();
        use rcad_algo::bop::ds::pave::{Pave, PaveBlock};
        let pv1 = Pave {
            vertex_idx: 0,
            param: 0.0,
        };
...
mod face_info_tests {
    ...
    fn has_any_interference_empty() {
        use rcad_algo::bop::ds::face_info::FaceInfo;
...
mod pave_filler_internal_tests {
    use super::*;
    use rcad_algo::bop::algo::pave_filler::build_face_shape_map;
    use rcad_algo::bop::ds::{DSEdge, DSFace, DSVertex, ShapeOrigin};
    use glam::DVec3;
    ...
    use rcad_algo::bop::ds::pave::NO_EDGE;
