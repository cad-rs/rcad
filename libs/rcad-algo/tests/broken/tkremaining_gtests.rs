...
mod tkgeom_algo_tests {
    ...
    fn circle_tangent_to_line_and_bezier() {
        use rcad_algo::geom2d_api::tangent::circles_tangent_to_circle_and_line_through_point;
    ...
    fn circle_tangent_3_circles() {
        use rcad_algo::geom2d_api::tangent::circles_tangent_to_three_circles;
        let c1 = Circle2d {
    ...
    mod intpatch_gtests {
        ...
        use rcad_algo::bop::algo::pave_filler::polyhedron_bvh::{BVHTraversal, PolyhedronBVH};
    ...
    use rcad_algo::bop::int_tools::int_patch_intersection::IntPatchIntersection;
