...
fn vert_point(brep: &BRep, vi: usize) -> DVec3 {
    brep.vertex_point(vi)
        .unwrap_or_else(|| panic!("fillet: vertex tshape {vi} not found"))
}
...
fn classify_edge_convexity(brep: &BRep, edge_idx: usize, f0: usize, f1: usize) -> EdgeConvexity {
...
//  鈧?鈧?History types  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
//  鈧?鈧?Internal helpers  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
                            ...
                            let outer =
                                if let TShape::Wire(wd) = &*brep.tshapes[fd.outer_wire.index] {
                                    wd.edges
                                        .iter()
                                        .enumerate()
                                        .map(|(pos, esr)| (pos, remap[esr.index]))
                                        .collect()
                                } else {
                                    Vec::new()
                                };
                            let inners: Vec<Vec<(usize, usize)>> = fd
                                .inner_wires
                                .iter()
                                .map(|iw_sr| {
...
//  鈧?鈧?Chamfer  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
//  鈧?鈧?Angle-mode chamfer  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
///
/// The setback on Face 1 is derived from the dihedral angle and the chamfer
/// angle using:
///
/// ```text
/// sb1 = dist * sin( ) / sin( ? )
/// ```
///
/// For a 90  edge this simplifies to `sb1 = dist * tan( )`.  Setting
/// `  =  /2` produces a symmetric chamfer identical to [`chamfer_edge`] with
/// distance `dist`.
///
/// # Errors
...
/// faces, the setback direction cannot be computed, or `angle_rad  ? `
...
pub fn chamfer_edge_angle_with_history(
    ...
    // Compute the dihedral angle (same formula as fillet_edge).
    let n0 = face_normal(brep, f0);
    let n1 = face_normal(brep, f1);
    let cos_angle = n0.dot(n1).clamp(-1.0, 1.0);
    ...
    // sb1 = dist * sin( ) / sin( ? )  (setback on Face 1)
    let sb0 = dist;
...
//  鈧?鈧?Safe (auto-clamping) fillet / chamfer  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
fn max_safe_setback(brep: &BRep, edge_idx: usize) -> f64 {
    ...
    for &fi in &[f0, f1] {
        ...
        if let TShape::Wire(wd) = &*brep.tshapes[fd.outer_wire.index] {
            for esr in &wd.edges {
                if esr.index == edge_idx {
                    continue;
                }
                if let TShape::Edge(e) = &*brep.tshapes[esr.index] {
                    let l =
                        (vert_point(brep, e.first.index) - vert_point(brep, e.last.index)).length();
                    if l < min_len {
                        min_len = l;
                    }
                }
...
//  鈧?鈧?Fillet  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
pub fn fillet_edge_with_history(
    ...
    // For convex edges: beta = - acos(n0 n1) (exterior/material angle)
...
/// (`r / tan( /2)`) so the blend vertices are geometrically accurate.
...
//  鈧?鈧?Variable-radius fillet rebuild  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
fn rebuild_with_variable_fillet_verts_history(
    ...
    let blend_surf =
        if (start_radius - end_radius).abs() < 1e-10 * (start_radius + end_radius + 1.0) {
...
//  鈧?鈧?Shared rebuild core  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
//  鈧?鈧?Corner blend  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
    ...
    for &fi in &face_idxs {
        ...
        let new_boundary = {
            ...
            for p in new_boundary {
                if deduped.is_empty()
                    || !points_coincide(*deduped.last().expect("deduped is non-empty"), p)
                {
                    deduped.push(p);
                }
            }
...
//  鈧?鈧?Module re-export helper used in tolerance check  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?

fn points_coincide(a: DVec3, b: DVec3) -> bool {
    (a - b).length() < 1e-8
}

//  鈧?鈧?Tests  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
mod tests {
    ...
    //  鈧?鈧?Angle-mode chamfer tests  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
    ...
    fn chamfer_angle_asymmetric_setbacks_on_90deg_edge() {
        ...
        // The setback on face 1 should  ?dist * tan(30 ) = dist/ ?  ?0.1732.
    ...
    fn chamfer_angle_rejects_angle_ge_dihedral() {
        // On a 90  edge (  =  /2), passing angle_rad =  /2 should fail.
        let brep = box_brep_2x2x2();
        assert!(
    ...
    fn fillet_concave_edge_produces_valid_result() {
        ...
        for &(a, b) in &edge_list {
            ...
            brep.edges
                .push(rcad_kernel::topology::Edge { start: a, end: b });
    ...
    fn fillet_cylinder_adjacent_edge() {
        ...
        for (ei, _edge) in legacy.edges.iter().enumerate() {
            if let Some((f0, f1)) = find_adjacent_faces(&legacy, ei) {
                ...
                let has_curved = s0
                    .map(|si| !matches!(legacy.geom.surfaces[*si], Surface3::Plane(_)))
                    .unwrap_or(false)
                    || s1
                        .map(|si| !matches!(legacy.geom.surfaces[*si], Surface3::Plane(_)))
                        .unwrap_or(false);
    ...
    //  鈧?鈧?Safe fillet / chamfer tests  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
    ...
    fn fillet_safe_large_radius_is_clamped() {
        ...
        assert!(
            result.effective_param < 5.0,
            "effective radius should be < requested"
        );
    ...
    //  鈧?鈧?Edge case tests  鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?鈧?
...
pub fn chamfer_edge_angle_topods(
    brep: &BRep,
    edge_idx: usize,
    dist: f64,
    angle_rad: f64,
...
pub fn fillet_edge_variable_radius_topods(
    brep: &BRep,
    edge_idx: usize,
    start_radius: f64,
    end_radius: f64,
