...
pub fn is_hole_wire(edges: &[crate::bopds::pave::PaveBlock]) -> bool {
    edges.len() == 1
}
...
pub fn compute_tolerance_of_cb(cb: &crate::bopds::common_block::CommonBlock, ds: &DS) -> f64 {
...
pub fn compute_vv(
    v1: &crate::bopds::ds::DSVertex,
    v2: &crate::bopds::ds::DSVertex,
    fuzz: f64,
) -> i32 {
...
pub fn get_edge_on_face(
    ei: usize,
    ds_edges: &[crate::bopds::ds::DSEdge],
...
pub fn is_open_shell(shell_faces: &[usize], ds: &crate::bopds::ds::DS) -> bool {
...
pub fn make_vertex_from_list(ds: &mut crate::bopds::ds::DS, vertex_indices: &[usize]) -> usize {
