...
pub fn prepare_lines_3d(curves: &mut Vec<crate::bop::ds::ds::IntersectionCurve>, b_to_split: bool) {
    ...
    let mut new_curves: Vec<crate::bop::ds::ds::IntersectionCurve> = Vec::with_capacity(curves.len());
    for ic in curves.drain(..) {
        ...
        if b_to_split {
            if let Some([r0, r1]) = split_closed_curve(&ic.curve, &tr) {
                ...
                let first_half = crate::bop::ds::ds::IntersectionCurve {
                    t_range: r0,
                    pcurve_on_a: ic
                        .pcurve_on_a
                        .as_ref()
                ...
                let second_half = crate::bop::ds::ds::IntersectionCurve {
                    t_range: r1,
                    pcurve_on_a: ic
                        .pcurve_on_a
                        .as_ref()
