...
/// }
/// ```
use crate::bop::ds::{DS, Interference};
...
impl CheckerSI {
    ...
    // 鈹€鈹€ Filter helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    /// but that is not a "self-interference" 鈥?it is just the same entity.
    fn is_non_trivial(
        interf: &Interference,
        ds: &DS,
        a_vc: usize,
    ...
    /// range at a matching offset, they are the same original entity 鈫?trivial.
    ...
    ///
    /// Since PaveFiller iterates both A鈫払 and B鈫扐, `vertex` may be from the A
