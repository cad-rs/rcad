...
// ── FindValidRange / ShrunkData helper functions (OCCT BRepLib_1.cxx L26-219) ──



/// Curve parameter step: parameter increment needed to move tol distance along curve (OCCT Adaptor3d_Curve::Resolution)
...
/// ✅ OCCT-aligned: findNearestValidPoint (BRepLib_1.cxx L31-148)

/// Step along the curve from one end until outside the vertex tolerance sphere, then bisect to refine.
...
/// ✅ OCCT-aligned: FindValidRange (BRepLib_1.cxx L153-220)
