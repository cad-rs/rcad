...
impl<'a> super::PaveFiller<'a> {
    ...
    pub(crate) fn intersect_face_face(&mut self, work: &FFWork) {
        ...
        let mut lconstruct =
            crate::inttools::int_patch_line_constructor::GeomIntLineConstructor::new();
    ...
    pub(crate) fn compute_tol_and_prepare_lines_3d(
        ...
        inttools::pcurve_derive::prepare_lines_3d(&mut self.ds.intersection_curves, b_split_curve);
    ...
    pub(crate) fn make_intersection_curve(
        ...
        match typl {
            ...
            | crate::inttools::int_patch_type::IntPatchIType::Hyperbola => self
            ...
            | crate::inttools::int_patch_type::IntPatchIType::Ellipse => self
    ...
    fn put_points_on_line(
        ...
        for &pt in ef_points {
            ...
            let p3d = curve.point_at(t);
            line.vertices
                .push(crate::inttools::int_patch_line::IntPatchVertex {
                    param_on_line: t,
                    p3d,
