...
fn build_steinmetz_brep(
 ...
 // CylA (Z-axis): P(u,v) = (R cos(u), R sin(u), v)  ?V0(0,100), V1(0,300), V2(3 /2,200), V3( /2,200), V4( ,300)
 // CylB (X-axis): P(u,v) = (150-v, -R sin(u), 200-R cos(u))  ?V0(0,50), V1( ,50), V2( /2,150), V3(3 /2,150), V4( ,250)
 let face_uv = [
 ...
 // For face A1(u 0,3 /2]): UV_area = 6R, SA = 6R 
 // For face A2(u 0, /2]): UV_area = 2R, SA = 2R 
 // For face A3(between E ?and E ? u /2,3 /2]): UV_area = 4R, SA = 4R 
...
pub(crate) fn build_sphere_clipped_by_z_planes(
 ...
 // Set face_surface_range to restrict to [0,2 ?[v_hi, v_lo]
