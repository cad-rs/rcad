...
/// Flat BRep face index 閳?geometric floor for numerical IntSS (phase C).
#[inline]
...
///
/// Used for mesh閳ユ悎esh intersection approximations (e.g. OCCT-style section).
...
/// Triangle閳ユ悤riangle chaining with pair/merge epsilon from [`crate::tolerance::tessellation_merge_linear_from_two_breps`]
...
// 閳光偓閳光偓 Public API: Plane Section 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
...
fn try_analytic_face_pair(
    ...
    match (sa, sb) {
        // 閳光偓閳光偓 Plane 鑴?Plane 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
        (Plane(pa), Plane(pb)) => {
        ...
        // 閳光偓閳光偓 Plane 鑴?Cylinder 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
        ...
        // 閳光偓閳光偓 Plane 鑴?Sphere 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
        (Plane(pa), Sphere(sb)) => {
        ...
        // 閳光偓閳光偓 Plane 鑴?Cone 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
        (Plane(pa), Cone(cb)) => {
        ...
        while j < segs.len() {
            ...
            if dir.dot(c_dir).abs() > 1.0 - eps {
                ...
                if c_t1 >= -eps && c_t0 <= len + eps {
                    ...
                    segs.swap_remove(j);
                    merged = true;
                    break; // segs[i] changed 閳?restart inner loop
                }
            }
            j += 1;
        }
...
/// planes 閳?i.e. both are [`Surface3::Plane`] with the same normal and origin
...
fn is_coplanar_face_pair(brep_a: &BRep, flat_a: usize, brep_b: &BRep, flat_b: usize) -> bool {
    ...
    match (surf_a, surf_b) {
        (Some(Surface3::Plane(pa)), Some(Surface3::Plane(pb))) => {
            ...
            // Same distance from origin 閳?project the origin offset onto either normal
...
// 閳光偓閳光偓 Public API: Curved Surface Section 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
...
// 閳光偓閳光偓 Section Properties Computation 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
