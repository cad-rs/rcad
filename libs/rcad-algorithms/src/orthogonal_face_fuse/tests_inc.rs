...
mod orth_union_tests {
    ...
    /// L-shaped outline keeps >4 corners; a 3鑴? rectangle of samples collapses to 4 corners.
    #[test]
...
/// OCCT `bcommon_simple/G1` intersection: document axis-UV bbox overlap vs strict containment between coplanar 鍗xis faces.
///
