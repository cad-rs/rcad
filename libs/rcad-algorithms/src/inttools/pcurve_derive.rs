...
mod tests {
    ...
    fn circle_on_plane_is_circle() {
        ...
        let circle = Circle3::new(DVec3::new(1.0, 0.0, 0.0), DVec3::Z, 3.0);
    ...
    fn circle_on_sphere_is_latitude() {
        ...
        let circle = Circle3::new(DVec3::ZERO, DVec3::Z, (3.0_f64).sqrt());
    ...
    fn circle_on_cone_is_h_line() {
        ...
        let circle = Circle3::new(DVec3::ZERO, DVec3::Z, h * cone.half_angle_rad.tan());
    ...
    fn circle_on_sphere_non_axis_normal() {
        ...
        let circle = Circle3::new(DVec3::new(0.5, 0.0, 0.0), DVec3::X, (0.75_f64).sqrt());
