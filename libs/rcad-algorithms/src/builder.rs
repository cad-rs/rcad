...
fn find_interior_3d(
 ...
 // (sphere: [0,2 - ?2, ?2]), try the domain center or points opposite.
 let mut c = vec![
 ...
 *self.my_arguments.borrow_mut() = args;
 ...
 /// offsets of = riod to make the polyline continuous in U.
 ...
 //  ====span-checking guard (AFTER clipping)  ==== = ==== = ==== = ==== = ==== = ==== = ==== = ? // If this axis-aligned trim already covers =0 % of the boundary span
