...
- **门槛（本轮逐字复测，均为实测）**：lib **412/0/0** · kernel **677/0** · 八网格 **bopfuse 371/4 · bopcommon 374/4 · bopcut 379/0 · boptuc 369/4 · splitter 10/2 · bfuse_simple 102/102 · bcommon_simple 83/83 · bcut_simple 109/109（`-Exclude g6`）——失败集逐字不变**。
