...
| `hlr/` | TKHLR | `HLRBRep`、`HLRAlgo`、`HLRAppli`、`HLRTopoBRep`、`Contap`、`Intrv`、`TopBas`、`TopCnx` | ◐ 推进中（精确线路 Stage 0-4；poly 线路单列）——**分 session runway 计划与进度勾选表见 `docs/tkhlr-port-plan.md`（2026-09-04 勘察落盘），每 session 开场先读它** |
