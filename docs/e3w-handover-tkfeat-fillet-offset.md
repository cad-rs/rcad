...
> **先读顶部"追加 41 收尾态"一行 + §0.0q**）与 `rcad/docs/tkfeat-fillet-offset-port-plan.md` §E3-W 追加 11–41
> （权威脉络，**追加 41 是当前状态**）；
...
### 0.0q 追加 41 收尾态（2026-09-14；**最新** —— 引擎补全轮：AppDef_Compute + Approx_SweepApproximation + 面级 BSpline + GProps + CompCurve 双类 + pipe law 链 + en_large_face 补全）
