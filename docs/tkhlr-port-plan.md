...
> - **下一步 = 2b：Contap 包 1:1**（SurfProps→HContTool→HCurve2dTool→Point/Line→SurfFunction→ArcFunction→ContAna→Contour 2389 行）。次序与接通点见 §8。
